...
public class UserOptions {
    ...
    private static void option2() {
        ...
        Scanner s = new Scanner(System.in);
        System.out.print("Enter the ID of the request you want to cancel:");//reimbursementId:Reimbursement Model
        ...
        if (dataBaseReimburseId == reimburseId) {
            ...
            Reimbursement r = new Reimbursement(reimburseId);

            rServ.delete(r);
            System.out.println("2- You request has been Canceled.");
